...
- Name: signupPageTest.spec.js >> TC#1: User Sign Up Account
      ...
      - generic [ref=e4]:
        ...
        - generic [ref=e9]:
          - generic [ref=e10]:
            ...
            - textbox "Username:" [ref=e12]: nimisha18
          - generic [ref=e13]:
            - generic [ref=e14]: "Password:"
            - textbox "Password:" [ref=e15]: "123456"
        - generic [ref=e17]:
...
```ts
  ...
  14 |         this.signUpButton = page.locator('#signInModal button.btn-primary')
  15 |         this.closeButton = page.locator('#signInModal button.btn-secondary')
  16 |     }
  17 | 
  18 |     async goto() {
...
> 28 |         page.on('dialog', async (dialog) => {
  ...
  34 | 
  35 |     async close(){
  36 |         await this.signUpMenu.click()
  37 |         await this.closeButton.click()
  38 |     }
  39 | 
  40 | }
```