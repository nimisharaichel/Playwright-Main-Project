      ...
      - generic [ref=e4]:
        ...
        - generic [ref=e9]:
          - generic [ref=e10]:
            ...
            - textbox "Username:" [ref=e12]: nimisha_Varghese1
          - generic [ref=e13]:
            - generic [ref=e14]: "Password:"
            - textbox "Password:" [ref=e15]: Nimi@123
        - generic [ref=e17]:
...
```ts
  ...
  12 | 
  13 |     await signupPage.signup(user, pass)
  14 | 
  15 |     // Wait for alert properly
> 16 |     const dialogPromise = page.waitForEvent('dialog')
     |                                ^ Error: page.waitForEvent: Test timeout of 30000ms exceeded.
  17 | 
